        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center p-0 sm:p-4 bg-black/80 backdrop-blur-sm">
            <div className={`w-full max-w-md bg-wc-light-bg rounded-t-[40px] sm:rounded-[40px] overflow-hidden shadow-2xl transform transition-transform duration-500 ease-out ${animate ? 'translate-y-0' : 'translate-y-full'}`}>
                ...
                <div className="px-6 pb-6 text-center">
                    <h2 className="text-2xl font-bold text-gray-900">Carta Escaneada</h2>
                    ...
                    <div className="mt-8 mb-8 relative flex justify-center">
                        ...
                        <div className="relative z-10 w-64 aspect-3/4 rounded-2xl overflow-hidden shadow-2xl transform rotate-1 hover:rotate-0 transition duration-500 bg-white p-2 border border-gray-100">
                    ...
                    <div className="flex justify-center space-x-6 mb-8">
                        <div className="text-center">
                            <div className="text-xs font-bold text-gray-400 mb-1">RITMO</div>
                            <div className="text-xl font-black text-wc-green">{card.stats?.speed || 88}</div>
                        ...
                        <div className="text-center">
                            <div className="text-xs font-bold text-gray-400 mb-1">TIRO</div>
                            <div className="text-xl font-black text-yellow-500">{card.stats?.shooting || 85}</div>
                            <div className="w-12 h-1 bg-gray-200 rounded-full mt-1 overflow-hidden">
                                <div className="h-full bg-yellow-500" style={{ width: `${card.stats?.shooting || 85}%` }}></div>
                            </div>
                        </div>
                        <div className="text-center">
                            <div className="text-xs font-bold text-gray-400 mb-1">FÍSICO</div>
                            <div className="text-xl font-black text-wc-red">{card.stats?.power || 90}</div>
                            <div className="w-12 h-1 bg-gray-200 rounded-full mt-1 overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        <button
                            onClick={onAdd}
                            className="py-5 px-6 rounded-2xl bg-wc-green border-2 border-wc-green text-white font-bold hover:bg-green-700 hover:border-green-700 transition-all duration-200 flex flex-col items-center justify-center gap-2 shadow-lg hover:shadow-xl active:scale-95"
                        >
                        ...
                        <button
                            className="py-5 px-6 rounded-2xl bg-white border-2 border-gray-300 text-gray-700 font-bold hover:bg-gray-100 hover:border-gray-400 transition-all duration-200 flex flex-col items-center justify-center gap-2 shadow-lg hover:shadow-xl active:scale-95"
                        >
