                    ...
                    <div className="h-20 bg-white/10 backdrop-blur-xl rounded-[2rem] border border-white/10 flex items-center justify-between px-2 shadow-lg">
                        ...
                        {onAddFilters && (
                            <button
                                ...
                                className="flex-1 h-14 mx-1 rounded-[1.5rem] bg-indigo-500/20 hover:bg-indigo-500/40 text-white flex flex-col items-center justify-center gap-1 transition group border border-white/5"
                            >
                                ...
                                <span className="text-[9px] font-bold uppercase tracking-wider opacity-80">Editar</span>
                            </button>
                        )}
                        ...
                        <button
                            onClick={onClose}
                            className="flex-1 h-14 mx-1 rounded-[1.5rem] bg-red-500/20 hover:bg-red-500/40 text-white flex flex-col items-center justify-center gap-1 transition group border border-white/5"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 group-hover:scale-110 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                            </svg>
                            <span className="text-[9px] font-bold uppercase tracking-wider opacity-80">Cerrar</span>
                        </button>
                    </div>
                </div>
