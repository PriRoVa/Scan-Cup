...
function App() {
  ...
  const renderContent = () => {
    switch (view) {
      ...
      case 'catalog':
        return <CatalogCollection cards={mockCards} onBack={() => setView('home')} />;
      case 'profile':
      ...
      case 'trivia':
        return <Trivia />;
      case 'market':
        return <div className="flex items-center justify-center h-screen bg-wc-light-bg text-gray-800 font-bold">Próximamente: Tienda</div>;
      default:
